...
<%@ page import="com.telusko.JobHunt.model.JobPost" %>
...
<%  JobPost myjob = (JobPost)request.getAttribute("jobPost"); %>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card border-dark bg-dark text-white">
                <div class="card-body">
                    <h5 class="card-title"><%= myjob.getPostProfile() %></h5>
                    <p class="card-text">
                    ...
                    <p class="card-text">
                        ...
                        <%= myjob.getReqExperience() %> years
                    </p>
                    <p class="card-text">
					    <strong>Tech Stack Required:</strong>
					    <ul>
							<% for(String s : myjob.getPostTechStack())
								{%>
									<li><%= s %></li>
								<%}%>
					    </ul>
